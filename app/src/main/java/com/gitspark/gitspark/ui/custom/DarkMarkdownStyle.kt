...
class DarkMarkdownStyle : DarkBootstrap() {

    init {
        addRule("body", "height: 100%", "line-height: 1.6", "padding-top: 16px", "background-color: #171717", "color: #f9f9f9")
        addRule("h1", "font-size: 28px", "color: #f9f9f9")
        addRule("h2", "font-size: 24px", "color: #f9f9f9")
        addRule("h3", "font-size: 18px", "color: #f9f9f9")
        addRule("h4", "font-size: 16px", "color: #f9f9f9")
        addRule("h5", "font-size: 14px", "color: #f9f9f9")
        addRule("h6", "font-size: 14px", "color: #f9f9f9")
        addRule(
            "pre",
            "position: relative",
            "padding: 14px 10px",
        ...
        addRule("table tr:nth-child(2n)", "color: #f9f9f9", "background-color: #f6f8fa")
        addRule("table th", "padding: 6px 13px", "border: 1px solid #f9f9f9")
        addRule("table td", "padding: 6px 13px", "border: 1px solid #f9f9f9")
        addRule(
            "kbd",
            "color: #444d56",
        ...
        addRule("pre:not([language])", "padding: 6px 10px", "background-color: #171717", "color: #f9f9f9")
...
open class DarkBootstrap : InternalStyleSheet() {
    ...
    init {
        ...
        addRule("p", "margin: 0 0 10px", "color: #f9f9f9")
        addRule("strong", "font-weight: 700", "color: #f9f9f9")
        addRule("em", "font-style: italic", "color: #f9f9f9")
